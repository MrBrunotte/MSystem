...
namespace ManagementSystem.Controllers
{
    public class MachinesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MachineName,Status,Data")] Machine machine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,MachineName,Status,Data")] Machine machine)
        {
            if (id != machine.Id)
            {
                return NotFound();
